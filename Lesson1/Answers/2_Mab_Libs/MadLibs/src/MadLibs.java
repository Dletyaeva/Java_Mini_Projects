...
public class MadLibs {
    ...
    public static void main(String[] args){
        String name1="Johnson", name2="Amy", 
        adjective1="weary", adjective2="peaceful", adjective3="voracious", 
        noun1="ring", noun2="clock-tower", noun3="tree", noun4="fence", noun5="pond", noun6="watch",
        place1="ruins", verb1="run";
        int number=1026;
