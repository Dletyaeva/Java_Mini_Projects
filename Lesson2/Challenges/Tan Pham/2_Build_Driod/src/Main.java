 ...
 */
 ...
 class Droid{
    ...
    public void energyReport(){
      System.out.println(droidName + "'s " + "Battery is at " + batteryLevel + "%");
      }
    public void energyTransfer(Droid otherDroid, int chargeTransfer){
      if (batteryLevel >= chargeTransfer){
        System.out.println(droidName + " is transfering " + chargeTransfer + "% battery charge to " + otherDroid.droidName);
        System.out.println("Transfer in progress");
        otherDroid.batteryLevel += chargeTransfer;
        System.out.println("Transfer Complete");
        batteryLevel -= chargeTransfer;
      } else {
        System.out.println("ERROR: " + droidName + " DOES HAVE THE REQUIRED POWER");
      }
    }
...
public class Main{
        ...
        Droid bot1 = new Droid("Codey");
        Droid bot2 = new Droid("Zippy");
        System.out.println(bot1.stateName());
        bot1.performTask("Fighting");
        bot1.performTask("Dancing");
        bot1.performTask("Walking Home");
        bot1.energyReport();
        bot2.energyReport();
        bot2.energyTransfer(bot1, 30);
        bot1.energyReport();
        bot2.energyReport();
        }
      }
